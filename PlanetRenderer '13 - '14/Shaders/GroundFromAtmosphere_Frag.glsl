...
vec3 color;
//martian: vec3(0.7647, 0.3843, 0.2549);
...
vec3 wetterCol = vec3(mix(colderDry, whiteIce, smoothstep(0.95, 0.955, b) ));
vec3 col1 = wetterCol;
...
float blend2 = smoothstep(0.35,0.70,slope);
...
//gl_FragColor = vec4(0.0,(h00-1.0)/2.0,0.0,1.0);
